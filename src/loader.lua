return function(boot)
	...
	local function start()
		...
		-- Keep startup lazy. Older builds warmed essentially the entire repository
		-- before attaching to FiveRose, which adds avoidable HTTP/file/compile work
		-- during the most CPU-sensitive part of startup. Runtime imports are cached
		-- normally as they are actually needed for the current game.
